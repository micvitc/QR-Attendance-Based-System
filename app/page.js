...
export default function SimpleCard() {
  ...
  return (
      ...
      <div className="grid mt-20 place-content-center">
        ...
        <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-3xl hover:bg-gray-100  ">
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <button type="button" className=" w-56 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Get Started</button>
          </div>
