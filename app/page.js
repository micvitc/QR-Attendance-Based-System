...
export default function SimpleCard() {
  ...
  return (
      ...
      <div className="grid mt-20 place-content-center">
        ...
        <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 w-full">
          <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <button type="button" class="w-1/2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Get Started</button>
          </div>
          <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="/logo.png" alt="logo" />
        </div>
      </div>
